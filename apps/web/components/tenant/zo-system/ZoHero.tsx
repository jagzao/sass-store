      ...
      <div className="container mx-auto text-center z-10 relative">
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6 font-[family-name:var(--font-rajdhani)] uppercase text-white drop-shadow-[0_0_15px_rgba(255,128,0,0.1)]">
            ...
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-[#AAAAAA]">
              de Alto Impacto
            </span>
          </h1>

          <p className="text-lg md:text-2xl text-gray-400 max-w-3xl mx-auto mb-10 font-[family-name:var(--font-montserrat)] leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link
              ...
              className="group relative px-8 py-4 rounded-lg bg-[#FF8000] text-white font-bold text-lg tracking-wider overflow-hidden shadow-[0_0_20px_rgba(255,128,0,0.3)] hover:shadow-[0_0_40px_rgba(255,128,0,0.5)] transition-all duration-300"
            >
            ...
            <Link
              ...
              className="group relative px-8 py-4 rounded-lg border border-[#EAFF00] text-[#EAFF00] font-bold text-lg tracking-wider hover:bg-[#EAFF00]/10 transition-all duration-300 shadow-[0_0_10px_rgba(234,255,0,0.1)] hover:shadow-[0_0_20px_rgba(234,255,0,0.2)]"
            >
