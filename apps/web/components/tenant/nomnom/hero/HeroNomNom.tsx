...
const defaultSlides: Slide[] = [
  {
    id: "1",
    img: "/tenants/nom-nom/hero/taco1.png",
    title: "Tacos al Pastor",
    desc: "Deliciosos tacos al pastor con piña asada, cebolla y cilantro.",
    price: "$12",
    bgColor: "#9c4d2f",
  },
  {
    id: "2",
    img: "/tenants/nom-nom/hero/taco2.png",
    title: "Tacos de Carnitas",
    desc: "Carnitas estilo Michoacán, tiernas y jugosas.",
    price: "$13",
    bgColor: "#f5bfaf",
  },
  {
    id: "3",
    img: "/tenants/nom-nom/hero/taco3.png",
    title: "Tacos de Birria",
    desc: "Birria de res con queso fundido, cebolla y cilantro.",
    price: "$15",
    bgColor: "#dedfe1",
  },
  {
    id: "4",
    img: "/tenants/nom-nom/hero/taco4.png",
    title: "Tacos Vegetarianos",
    desc: "Champiñones salteados, pimientos y aguacate fresco.",
    price: "$11",
    bgColor: "#7eb63d",
  },
];

export default function HeroNomNom({
  ...
  const animate = useCallback(
    async (direction: "next" | "prev") => {
      ...
      const center = window.matchMedia("(min-width:1280px)").matches
        ? "70% 50%"
        : "66% 54%";
      ...
      tl.add("start")
        .to(
          root,
          { backgroundColor: nextSlide.bgColor, duration: 0.45 },
          "start",
        )
        .fromTo(
          mask as any,
        ...
        .to(
          title,
          { y: 0, opacity: 1, filter: "blur(0)", duration: 0.33 },
          "start+=0.10",
        )
        .to(
          desc,
