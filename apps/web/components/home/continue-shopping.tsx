...
const UnfinishedItemCard = memo<UnfinishedItemCardProps>(
  ({ item, onContinue, onRemove }) => {
    ...
    return (
      <div
        ...
        style={{
          borderLeftColor: "var(--color-brand, #DC2626)",
          borderLeftWidth: "4px",
        }}
      >
        ...
        <div className="bg-gray-50 px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <div
            className={`px-2 py-1 rounded-md text-xs font-medium ${progressInfo.color} ${progressInfo.bg}`}
          >
            {progressInfo.text}
          </div>
        </div>
