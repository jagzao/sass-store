  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div
        role="dialog"
        aria-modal="true"
        className="relative z-50 w-full max-w-md bg-white border border-[rgba(197,160,89,0.3)] shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-xl overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="p-6 bg-white space-y-6">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-1">{appointment.customerName}</h3>
            <p className="text-[#C5A059] font-medium">{appointment.serviceName}</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-[#F9F9F9] p-3 rounded-lg border border-gray-100 flex items-center gap-3">
               ...
               <div>
                 ...
                 <p className="text-sm font-bold text-gray-900">${appointment.totalPrice.toLocaleString("es-MX")}</p>
               </div>
            </div>
          </div>
          ...
          {/* Photo Placeholder */}
          <div>
            <p className="text-sm font-medium text-gray-700 mb-2">Foto del Diseño (Referencia)</p>
