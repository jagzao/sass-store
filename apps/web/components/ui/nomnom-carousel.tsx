...
const items: CarouselItem[] = [
  {
    ...
    price: "$20",
    description:
      "Delicioso café latte preparado con los mejores granos arábicos y leche vaporizada a la perfección. Una experiencia única para tu paladar.",
    image: "☕",
  ...
  },
  {
    ...
    price: "$22",
    description:
      "Combinación perfecta de chocolate, café y fresas frescas. Una bebida dulce y refrescante que despertará todos tus sentidos.",
    image: "🍓",
  ...
  },
  {
    ...
    price: "$18",
    description:
      "Doble shot de espresso italiano auténtico. Intenso, aromático y con el cuerpo perfecto para los verdaderos amantes del café.",
    image: "☕",
  ...
  },
  {
    ...
    price: "$25",
    description:
      "Té verde matcha premium de Japón combinado con leche cremosa. Una experiencia zen en cada sorbo con beneficios antioxidantes.",
    image: "🍵",
...
export function NomNomCarousel({ tenantData }: NomNomCarouselProps) {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#4f8b69", fontFamily: "Poppins, sans-serif" }}
    >
      {/* Header */}
      <header
        className="relative z-10 grid h-20"
        style={{
          gridTemplateColumns: "80px 1fr 750px",
      ...
      >
        ...
        <nav style={{ borderLeft: "1px solid rgba(255,255,255,0.3)" }}>
          <ul className="h-full flex justify-end items-center gap-8 pr-8 m-0 p-0 list-none">
            <li>
              <a
                href={`/t/${tenantData.slug}`}
                className="text-black font-medium no-underline hover:opacity-80"
              >
                Coffee
              </a>
            </li>
      ...
      {/* Carousel */}
      <main
        className={`carousel w-full h-screen overflow-hidden ${carouselDirection || ""}`}
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className="content"
                    style={{ padding: "150px 20px 20px 80px" }}
                  >
                    <h2
                      className="text-6xl font-bold mb-4"
                      style={{ fontFamily: "serif", fontSize: "5em" }}
                    >
                      {item.title}
                    </h2>
                    <p
