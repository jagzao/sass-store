...
import { db, customers, customerVisits, customerVisitServices } from "@sass-store/database";
...
export async function PATCH(
  ...
  try {
    ...
    const [updatedVisit] = await db
      ...
      .set({
        visitDate: body.visitDate ? new Date(body.visitDate) : existingVisit.visitDate,
        totalAmount: body.totalAmount?.toString() || existingVisit.totalAmount,
        notes: body.notes !== undefined ? body.notes : existingVisit.notes,
        nextVisitFrom: body.nextVisitFrom !== undefined ? body.nextVisitFrom : existingVisit.nextVisitFrom,
        nextVisitTo: body.nextVisitTo !== undefined ? body.nextVisitTo : existingVisit.nextVisitTo,
