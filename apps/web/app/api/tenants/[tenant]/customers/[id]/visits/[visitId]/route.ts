  ...
  try {
    ...
    const updatedVisit = await db.transaction(async (tx) => {
      ...
      if (data.totalAmount !== undefined)
        updatePayload.totalAmount = data.totalAmount.toString();
      if (data.notes !== undefined) updatePayload.notes = data.notes;
      if (data.nextVisitFrom !== undefined)
        updatePayload.nextVisitFrom = data.nextVisitFrom;
      if (data.nextVisitTo !== undefined)
        updatePayload.nextVisitTo = data.nextVisitTo;
