  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Gestiona todos los aspectos de tu negocio desde aquí</p>
      </div>
        ...
        {adminModules.map((module) => (
          ...
          >
            <div className="flex items-center mb-4">
              <div className={`${module.color} text-white p-3 rounded-lg text-2xl mr-4`}>
                {module.icon}
              </div>
      ...
      {/* Quick Stats */}
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Resumen Rápido</h2>
