...
const jun1: Expense[] = [
  ...
  { id: 'j1-didi-juan', name: 'Didi Juan (Tarjeta)', amount: 2441, totalDebt: 6305, dueDay: 11, dueMonthLabel: 'Jun', isRecurring: true, person: 'Juan', category: 'tarjeta', isPaid: false, isCreditCard: true, notes: 'Resta $6,305' },
  { id: 'j1-klar', name: 'Klar', amount: 7300, totalDebt: 21500, isRecurring: true, person: 'Compartido', category: 'tarjeta', isPaid: false, isCreditCard: true },
...
const jun15: Expense[] = [
  ...
  { id: 'j15-plata-ali', name: 'Plata Ali', amount: 200, totalDebt: 1874, dueDay: 24, dueMonthLabel: 'Jun', isRecurring: true, person: 'Ali', category: 'tarjeta', isPaid: false, isCreditCard: true, notes: 'Pago mínimo' },
...
// July 1: Specific + recurring from June 1
const jul1: Expense[] = [
  { id: 'jul1-palacio', name: 'Palacio', amount: 180, totalDebt: 2540, dueDay: 10, dueMonthLabel: 'Jul', isRecurring: false, person: 'Compartido', category: 'tarjeta', isPaid: false, isCreditCard: true },
  ...
  { id: 'jul1-didi-juan', name: 'Didi Juan (Tarjeta)', amount: 2441, totalDebt: 6305, dueDay: 11, dueMonthLabel: 'Jul', isRecurring: true, person: 'Juan', category: 'tarjeta', isPaid: false, isCreditCard: true, notes: 'Resta $6,305' },
  { id: 'jul1-klar', name: 'Klar', amount: 7300, totalDebt: 21500, isRecurring: true, person: 'Compartido', category: 'tarjeta', isPaid: false, isCreditCard: true },
...
// July 15: Specific + recurring from June 15
const jul15: Expense[] = [
  { id: 'jul15-plata', name: 'Plata (extra)', amount: 300, totalDebt: 2500, dueDay: 18, dueMonthLabel: 'Jul', isRecurring: false, person: 'Compartido', category: 'tarjeta', isPaid: false, isCreditCard: true },
  ...
  { id: 'jul15-plata-ali', name: 'Plata Ali', amount: 200, totalDebt: 1874, dueDay: 24, dueMonthLabel: 'Jul', isRecurring: true, person: 'Ali', category: 'tarjeta', isPaid: false, isCreditCard: true, notes: 'Pago mínimo' },
