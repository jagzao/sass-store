...
DROP TABLE IF EXISTS customer_visit_services CASCADE;
...
DROP TABLE IF EXISTS finance_movements CASCADE;
DROP TABLE IF EXISTS mercadopago_payments CASCADE;
DROP TABLE IF EXISTS mercadopago_tokens CASCADE;
