    ...
    it("returns eligible customers based on 15-20 day window", async () => {
      ...
      const mockQueryBuilder = {
        ...
        orderBy: vi.fn().mockResolvedValue([
          {
            customerId: "c1",
            customerName: "Eligible",
            customerPhone: "555-1111",
            visitDate: eligibleDate,
          },
          {
            customerId: "c2",
            customerName: "Too Recent",
            customerPhone: "555-2222",
            visitDate: notEligibleDate1,
          },
          {
            customerId: "c3",
            customerName: "Too Old",
            customerPhone: "555-3333",
            visitDate: notEligibleDate2,
          },
        ]),
      };
    ...
    it("filters out customers who already have future appointments scheduled", async () => {
      ...
      const mockQueryBuilder = {
        ...
        orderBy: vi.fn().mockResolvedValue([
          {
            customerId: "c1",
            customerName: "Has Future Booking",
            customerPhone: "555-1111",
            visitDate: eligibleDate,
          },
          {
            customerId: "c2",
            customerName: "No Future Booking",
            customerPhone: "555-2222",
            visitDate: eligibleDate,
          },
        ]),
    ...
    it("returns Err DomainError when database throws an exception", async () => {
      ...
      if (!result.success) {
        ...
        expect((result as any).error.message).toContain(
          "Error al calcular retouches pendientes",
        );
      }
    });
  });
