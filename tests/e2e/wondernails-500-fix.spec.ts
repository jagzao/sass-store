...
test.describe("Wondernails Page -500 Error Fix", () => {
  test("should load wondernails tenant page without500 error", async ({
    page,
  }) => {
    // Navigate to the wondernails tenant page
    const response = await page.goto("/t/wondernails");
  ...
  test("should load customers API without500 error", async ({ request }) => {
    ...
    const response = await request.get("/api/tenants/wondernails/customers");
  ...
  test("should load customers API with search filter without500 error", async ({
    request,
  }) => {
    // Test the customers API endpoint with search parameter
    const response = await request.get(
      "/api/tenants/wondernails/customers?search=john",
    );
  ...
  test("should load customers API with status filter without500 error", async ({
    request,
  }) => {
    // Test the customers API endpoint with status parameter
    const response = await request.get(
      "/api/tenants/wondernails/customers?status=active",
    );
  ...
  test("should load customers API with both search and status filters without500 error", async ({
    request,
  }) => {
    // Test the customers API endpoint with both search and status parameters
    const response = await request.get(
      "/api/tenants/wondernails/customers?search=a&status=active",
    );
  ...
  test("should maintain tenant isolation in customers API", async ({
    request,
  }) => {
