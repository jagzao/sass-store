-- =================================================================
-- VERIFICACIÓN FINAL PARA SUPABASE - SISTEMA DE INVENTARIO
-- =================================================================
...
SELECT 
    ...
    'Columnas encontradas: ' || COUNT(*) || ' de 10 esperadas'
...
SELECT 
    ...
    'Columnas encontradas: ' || COUNT(*) || ' de 8 esperadas'
FROM information_schema.columns 
WHERE table_schema = 'public' 
AND table_name = 'service_products'
...
SELECT 
    ...
    'Columnas encontradas: ' || COUNT(*) || ' de 12 esperadas'
FROM information_schema.columns 
WHERE table_schema = 'public' 
AND table_name = 'inventory_transactions'
...
SELECT 
    ...
    'Columnas encontradas: ' || COUNT(*) || ' de 13 esperadas'
FROM information_schema.columns 
WHERE table_schema = 'public' 
AND table_name = 'inventory_alerts'
...
SELECT 
    ...
    'Columnas encontradas: ' || COUNT(*) || ' de 11 esperadas'
FROM information_schema.columns 
WHERE table_schema = 'public' 
AND table_name = 'product_alert_config'
...
-- Mostrar todos los resultados detallados primero
SELECT 
    table_name,
    check_type,
    status,
