/**
 * Applies packages/database/migrations/add-development-portal-tables.sql via postgres.js
 * Usage: node scripts/apply-dev-portal-migration.mjs
...
try {
  ...
  console.log("Development portal migration applied successfully");
  await db.unsafe(seedSql);
  console.log("Wondernails business type seeded");
} catch (err) {
