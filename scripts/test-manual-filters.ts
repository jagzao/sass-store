...
async function testManualFilters() {
  ...
  try {
    ...
    console.log(`   ✅ PASS: All ${tenant1Products.length} products belong to ${tenant1.name}\n`);
    ...
    console.log(`   ✅ PASS: All ${tenant2Products.length} products belong to ${tenant2.name}\n`);
