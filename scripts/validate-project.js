...
class ProjectValidator {
  ...
  validateProjectStructure() {
    ...
    // Core directories
    this.check("Root package.json exists", () =>
    ...
    this.check("Database package exists", () =>
      this.dirExists("packages/database"),
    );
    this.check("Config package exists", () =>
      this.dirExists("packages/config"),
    );

    // Key configuration files
    this.check("Turbo config exists", () => this.fileExists("turbo.json"));
    this.check("Docker compose exists", () =>
      this.fileExists("docker-compose.yml"),
    );
    this.check("Playwright config exists", () =>
      this.fileExists("playwright.config.ts"),
    );
  }
  ...
  validateWebApp() {
    ...
    this.check("Web package.json exists", () =>
      this.fileExists("apps/web/package.json"),
    );
    this.check("Next.js config exists", () =>
      this.fileExists("apps/web/next.config.js"),
    );
    this.check("Tailwind config exists", () =>
      this.fileExists("apps/web/tailwind.config.js"),
    );
    this.check("PostCSS config exists", () =>
      this.fileExists("apps/web/postcss.config.js"),
    );
    this.check("TypeScript config exists", () =>
      this.fileExists("apps/web/tsconfig.json"),
    );

    // App directory structure
    this.check("App directory exists", () => this.dirExists("apps/web/app"));
    this.check("Layout file exists", () =>
      this.fileExists("apps/web/app/layout.tsx"),
    );
    this.check("Home page exists", () =>
      this.fileExists("apps/web/app/page.tsx"),
    );
    this.check("Globals CSS exists", () =>
      this.fileExists("apps/web/app/globals.css"),
    );

    // Components
    this.check("Components directory exists", () =>
      this.dirExists("apps/web/components"),
    );
  ...
  validatePackages() {
    ...
    // UI package
    this.check("UI package.json exists", () =>
      this.fileExists("packages/ui/package.json"),
    );
    this.check("UI index exists", () =>
      this.fileExists("packages/ui/index.tsx"),
    );
    this.check("UI utils exists", () =>
      this.fileExists("packages/ui/lib/utils.ts"),
    );

    // Database package
    this.check("Database package.json exists", () =>
      this.fileExists("packages/database/package.json"),
    );
    this.check("Database schema exists", () =>
      this.fileExists("packages/database/schema.ts"),
    );
    this.check("Database connection exists", () =>
      this.fileExists("packages/database/connection.ts"),
    );

    // Config package
    this.check("Config package.json exists", () =>
      this.fileExists("packages/config/package.json"),
    );
    this.check("Config index exists", () =>
      this.fileExists("packages/config/index.ts"),
    );
  }
  ...
  validateTests() {
    ...
    this.check("Click budget tests exist", () =>
      this.fileExists("tests/e2e/click-budget.spec.ts"),
    );
    this.check("Tenant security tests exist", () =>
      this.fileExists("tests/e2e/tenant-security.spec.ts"),
    );
  }
  ...
  validateDocumentation() {
    ...
    this.check("Architecture document exists", () =>
      this.fileExists("docs/ARCHITECTURE.md"),
    );
    this.check("Testing document exists", () =>
      this.fileExists("docs/TESTING.md"),
    );
  ...
  validateAgentsOutput() {
    ...
    this.check("Seeds directory exists", () =>
      this.dirExists("agents/outputs/seeds"),
    );
    this.check("Tenants seed exists", () =>
      this.fileExists("agents/outputs/seeds/tenants.json"),
    );
    this.check("Media plan exists", () =>
      this.fileExists("agents/outputs/media/plan.md"),
    );
  }
  ...
  validateInfrastructure() {
    ...
    this.check("CI/CD workflow exists", () =>
      this.fileExists(".github/workflows/ci.yml"),
    );
    this.check("Cost monitor script exists", () =>
      this.fileExists("scripts/cost-monitor.js"),
    );
    this.check("Cloudflare config exists", () =>
      this.fileExists("cloudflare/wrangler.toml"),
    );
  }
  ...
  validateClickBudgets() {
    ...
    this.check("Click budget constants defined", () => {
      try {
        ...
        return (
          testContent.includes("purchase: 3") &&
