...
| **STRY-026** | **PWA instalable por tenant + fix servicios + observabilidad** | **P0**  | **analysis** | **S2**    | **PM → Architect → Dev → QA → Security** → [`active/STRY-026-pwa-instalable-fix-servicios-observabilidad.md`](active/STRY-026-pwa-instalable-fix-servicios-observabilidad.md) |
