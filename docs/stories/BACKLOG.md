...
| **STRY-024** | **Editar datos personales del cliente desde el expediente** | **P1**    | **done**   | **S2**    | **Dev → QA**                                                                                                                                                                   |
| **STRY-025** | **Mejoras calendario, citas y notificaciones**              | **P1**    | **active** | **S2**    | **PM → Architect → Dev → QA**                                                                                                                                                  |
...
| STRY-023     | Sesiones deportivas (clases grupales)                       | P1        | **done**   | S2        | Dev → QA → [`completed/STRY-023-sesiones-deportivas.md`](completed/STRY-023-sesiones-deportivas.md) · spec [`.specs/sesiones_deportivas.md`](../.specs/sesiones_deportivas.md) |
...
| **STRY-026** | **PWA instalable por tenant + fix servicios + observabilidad** | **P0**  | **done** | **S2**    | **Dev → QA → Security** → [`completed/STRY-026-pwa-instalable-fix-servicios-observabilidad.md`](completed/STRY-026-pwa-instalable-fix-servicios-observabilidad.md) · PR [#4](https://github.com/jagzao/sass-store/pull/4) |
| **STRY-027** | **Legal readiness SaaS multi-tenant**                         | **P0**  | **analysis** | **S2**    | **PM → Architect → Dev → QA → Security** → [`active/STRY-027-legal-readiness-saas.md`](active/STRY-027-legal-readiness-saas.md) |
...
_Actualizado: 2026-07-07 — STRY-027 añadida a active: Legal readiness SaaS multi-tenant._
