-- Backup de Supabase - 2026-01-05T18-31-15-564Z
-- Proyecto: jedryjmljffuvegggjmw

-- Este archivo contiene un backup de la base de datos
-- Fecha de creación: 2026-01-05T18:31:15.565Z



-- Datos de la tabla: tenants
-- La tabla tenants no contiene datos


-- Datos de la tabla: tenant_configs
-- La tabla tenant_configs no contiene datos


-- Datos de la tabla: api_keys
-- La tabla api_keys no contiene datos


-- Datos de la tabla: products
-- La tabla products no contiene datos


-- Datos de la tabla: services
-- La tabla services no contiene datos


-- Datos de la tabla: staff
-- La tabla staff no contiene datos


-- Datos de la tabla: bookings
-- La tabla bookings no contiene datos


-- Datos de la tabla: media_assets
-- La tabla media_assets no contiene datos


-- Datos de la tabla: tenant_quotas
-- La tabla tenant_quotas no contiene datos


-- Datos de la tabla: orders
-- La tabla orders no contiene datos


-- Datos de la tabla: order_items
-- La tabla order_items no contiene datos


-- Datos de la tabla: payments
-- La tabla payments no contiene datos


-- Datos de la tabla: audit_logs
-- La tabla audit_logs no contiene datos


-- Datos de la tabla: tenant_channels
-- La tabla tenant_channels no contiene datos


-- Datos de la tabla: channel_accounts
-- La tabla channel_accounts no contiene datos


-- Datos de la tabla: channel_credentials
-- La tabla channel_credentials no contiene datos


-- Datos de la tabla: social_posts
-- La tabla social_posts no contiene datos


-- Datos de la tabla: social_post_targets
-- La tabla social_post_targets no contiene datos


-- Datos de la tabla: content_variants
-- La tabla content_variants no contiene datos


-- Datos de la tabla: posting_rules
-- La tabla posting_rules no contiene datos


-- Datos de la tabla: post_jobs
-- La tabla post_jobs no contiene datos


-- Datos de la tabla: post_results
-- La tabla post_results no contiene datos


-- Datos de la tabla: media_renditions
-- La tabla media_renditions no contiene datos


-- Datos de la tabla: customers
-- La tabla customers no contiene datos


-- Datos de la tabla: customer_visits
-- La tabla customer_visits no contiene datos


-- Datos de la tabla: visit_photos
-- La tabla visit_photos no contiene datos


-- Datos de la tabla: customer_visit_services
-- La tabla customer_visit_services no contiene datos


-- Datos de la tabla: menu_designs
-- La tabla menu_designs no contiene datos


-- Datos de la tabla: users
-- La tabla users no contiene datos


-- Datos de la tabla: accounts
-- La tabla accounts no contiene datos


-- Datos de la tabla: sessions
-- La tabla sessions no contiene datos


-- Datos de la tabla: verification_tokens
-- La tabla verification_tokens no contiene datos


-- Datos de la tabla: user_roles
-- La tabla user_roles no contiene datos


-- Datos de la tabla: product_reviews
-- La tabla product_reviews no contiene datos


-- Datos de la tabla: financial_kpis
-- La tabla financial_kpis no contiene datos


-- Datos de la tabla: financial_movements
-- La tabla financial_movements no contiene datos


-- Datos de la tabla: user_carts
-- La tabla user_carts no contiene datos
