...
SELECT
  ...
  'Calle Principal 123, Colonia Centro, Texcoco, Estado de México',
  'Cliente frecuente, prefiere colores brillantes y diseños con flores',
  ARRAY['frecuente', 'preferente', 'alergia-látex'],
...
SELECT
  ...
  'Avenida Juárez 456, Colonia San Lorenzo, Texcoco, Estado de México',
  'Le gusta mantener uñas cortas y naturales, buena cliente',
  ARRAY['regular', 'natural'],
  'active'::customer_status,
  '{"preferences": {"colors": ["nude", "natural"], "styles": ["clásico", "corto"], "nail_type": "acrilico"}, "first_visit": "2024-02-20", "referral_source": "amiga"}'::jsonb
FROM tenants t WHERE t.slug = 'wondernails'
...
SELECT
  ...
  'Calle Hidalgo 789, Colonia Obrera, Texcoco, Estado de México',
  'Siempre pide diseños elaborados y nail art',
  ARRAY['vip', 'nail-art', 'diseños'],
  'active'::customer_status,
...
SELECT
  ...
  450.00,
  'Manicure gel completo con diseño de flores',
  NOW() + INTERVAL '20 days',
  NOW() + INTERVAL '27 days',
  'completed'::visit_status,
  '{"services": ["Manicure Gel Completo", "Nail Art Diseño Básico"], "duration": 90, "staff": "Marialicia Villafuerte Hurtado"}'::jsonb
FROM tenants t
JOIN customers c ON c.tenant_id = t.id
WHERE t.slug = 'wondernails' AND c.name = 'Ana García López'
...
FROM tenants t
JOIN customers c ON c.tenant_id = t.id
WHERE t.slug = 'wondernails' AND c.name = 'María Rodríguez Sánchez'
...
SELECT
  ...
  NOW() - INTERVAL '20 days',
  1000.00,
  'Uñas acrílicas esculpidas con diseño personalizado',
  NOW() + INTERVAL '25 days',
  NOW() + INTERVAL '32 days',
  'completed'::visit_status,
  '{"services": ["Uñas Acrílicas Esculpidas", "Nail Art Diseño Básico"], "duration": 150, "staff": "Marialicia Villafuerte Hurtado"}'::jsonb
FROM tenants t
JOIN customers c ON c.tenant_id = t.id
